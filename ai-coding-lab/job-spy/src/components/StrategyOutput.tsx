  ...
  return (
    <div className="rounded-lg border border-primary/20 bg-card/80 overflow-hidden border-l-[3px] border-l-primary">
      ...
      <div className="p-5 space-y-6 max-h-[700px] overflow-auto">
        {/* Resume Optimization */}
        {Array.isArray(strategy.resumeOptimization) && strategy.resumeOptimization.length > 0 && (
          <section>
        ...
        {Array.isArray(strategy.resumeOptimization) && strategy.interviewPrep && <Separator className="opacity-50" />}
        ...
        {strategy.interviewPrep && (
          <section>
            ...
            <div className="space-y-4 pl-6">
              {Array.isArray(strategy.interviewPrep.technicalQuestions) && strategy.interviewPrep.technicalQuestions.length > 0 && (
                <div>
              ...
              {Array.isArray(strategy.interviewPrep.behavioralQuestions) && strategy.interviewPrep.behavioralQuestions.length > 0 && (
                <div>
              ...
              {Array.isArray(strategy.interviewPrep.tips) && strategy.interviewPrep.tips.length > 0 && (
                <div>
        ...
        {/* Cover Letter */}
        {Array.isArray(strategy.coverLetterPoints) && strategy.coverLetterPoints.length > 0 && (
          <section>
            <h3 className="flex items-center gap-2 text-sm font-semibold mb-3">
        ...
        {Array.isArray(strategy.coverLetterPoints) && strategy.skillDevelopmentPlan && <Separator className="opacity-50" />}

        {/* Skill Development */}
        {Array.isArray(strategy.skillDevelopmentPlan) && strategy.skillDevelopmentPlan.length > 0 && (
          <section>
            <h3 className="flex items-center gap-2 text-sm font-semibold mb-3">
